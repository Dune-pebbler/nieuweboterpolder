...
<style>
    ...
    section.hero .banner-text .badge {
        position: absolute;
    ...
    section.hero .banner-text .badge h2 {
        color: white;
        text-align: center;
        margin-bottom: 0;
    ...
    section.hero .banner-text .badge a {
            ...
            <section class="hero-slider relative">
                ...
                <style>
                    ...
                    .hero .slide-item {
                        ...
                        /* You can change this to 80vh, 600px, etc. */
                    }
                    ...
                    .hero .slide-item img {
                        ...
                        /* Makes sure the image fills the slide nicely */
                        display: block;
                    }
                </style>
            </section>
                                            ...
                                            <div class="inner-container relative">
                                                ...
                                                <div class="text-container">
                                                    <div class="image-container relative">
                                                        <div class="inner-img-container background-cover"
                                                            style="display: flex; align-items:center;">
                                                            <?php if ($imageMain = get_field('woning_afbeelding')): ?>
                                                                <img class="contain" style="height: 100%;"
                                                                    src="<?= esc_url($imageMain['url']); ?>"
                                                                    alt="<?= esc_attr($imageMain['alt']); ?>" />
                                                            <?php endif; ?>
                                                            <?php if ($imageExtra = get_field('woning_extra_afbeelding')): ?>
                                                                <img class="contain" src="<?= esc_url($imageExtra['url']); ?>"
                                                                    alt="<?= esc_attr($imageExtra['alt']); ?>" />
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                    <div class="grouper">
                                    ...
                                    <div class="content-group flex-col" onclick="window.location.href='<?= get_permalink(); ?>';"
                                        ...
                                        <div class="text-group relative flex-col-between">
                                            <div class="grouper">
                                                ...
                                                <p style="font-weight: bold; text-decoration: underline;">Lees meer</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<style>
    ...
    textarea,
    select {
        color: rgb(152, 148, 148) !important;
    }
</style>
<?php get_footer(); ?>