      ...
      <div class="col-md-4">
        <div class="developer">
          ...
          <?php if ($imageDeveloper = get_field('ontwikkelaar_logo', 'option')) : ?>
            <img src="<?php echo esc_url($imageDeveloper['url']); ?>" alt="<?php echo esc_attr($imageDeveloper['alt']); ?>" />
          <?php endif; ?>
        </div>
        <div class="socials">
...
<div class="disclaimer-container">
  <div class="container">
    <div class="row">
      <div class="col-12 col-lg-6">
        <div class="privacy">
          <a href="<?= get_privacy_policy_url(); ?>">Privacy statement</a> - <a href="https://dunepebbler.nl" target="_blank">Website door Dune Pebbler</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="https://kit.fontawesome.com/5cc7a498dc.js" crossorigin="anonymous"></script>
  <?php wp_footer(); ?>
  </body>
